        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#inicio" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Início
                </a>
              </li>
              <li>
                <a href="#solucoes" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Soluções
                </a>
              </li>
              <li>
                <a href="#processo" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Como Funciona
                </a>
              </li>
              <li>
