...
const Hero = () => {
  return (
    <section id="inicio" className="bg-mok-blue py-24">
      <div className="w-full flex justify-center">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mb-16">
            ...
            <p className="text-[24px] font-bold text-mok-green leading-[1.2] max-w-4xl text-center mx-auto">
          ...
          <div className="flex justify-center">
            <div className="relative w-[371px] h-[371px]">
              ...
              <motion.div
                className="absolute inset-0 w-[371px] h-[371px] rounded-full border-[10px] border-dashed border-mok-green"
                animate={{ rotate: 360 }}
                transition={{
                  duration: 60,
                  repeat: Infinity,
              ...
              {/* Green Circle */}
              <div className="absolute left-[26px] top-[26px] w-[321px] h-[321px] rounded-full bg-mok-green flex items-center justify-center">
                {/* Pixelated Hand */}
