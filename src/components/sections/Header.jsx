        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden sm:flex items-center gap-2 sm:gap-4 md:gap-8">
            ...
            <a
              ...
              className="bg-mok-green text-mok-blue px-3 py-1.5 sm:px-4 sm:py-2 rounded-full font-semibold hover:bg-mok-green/90 transition-colors cursor-pointer text-sm sm:text-base"
            >
              PNLD
            </a>
          </div>
            ...
            <div className="flex flex-col px-4 py-2">
              ...
              <div className="mt-2 pt-2 border-t border-mok-blue/20">
                <a
                  href="/pnld"
                  onClick={handlePnldClick}
                  className="bg-mok-blue text-mok-green font-bold hover:bg-mok-blue/90 transition-all cursor-pointer text-base py-3 px-4 rounded-lg block text-center"
                >
                  PNLD
                </a>
              </div>
