...
const mdxComponents = {
  ...
  th: (props: any) => (
    <th className="px-4 py-2 bg-mok-green/20 text-mok-blue font-bold text-left" {...props} />
  ),
  td: (props: any) => (
      ...
      <div className="min-h-screen bg-white">
        ...
        <nav className="mb-8 text-sm">
          <ol className="flex items-center space-x-2 text-gray-500">
            <li>
              <Link href="/" className="hover:text-mok-blue transition-colors">
                Home
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/blog" className="hover:text-mok-blue transition-colors">
                Blog
              </Link>
            </li>
            <li>
