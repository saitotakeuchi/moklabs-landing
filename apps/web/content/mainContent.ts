export const mainContent = {
    ...
    steps: [
      {
        ...
        description: "pode ser um livro, curso, jogo ou conteúdo multimídia.",
      },
      {
        title: "Projetamos para sua necessidade",
        description:
          "cuidamos do design, programação, acessibilidade e interatividade.",
      },
      {
  ...
  ourWay: {
    ...
    highlights: [
      {
        icon: "/our-way-01.jpg",
        title: "Focamos em resultados reais.",
        description:
          "Cada projeto é pensado para gerar valor concreto e impacto positivo no seu negócio.",
      },
      {
        icon: "/our-way-02.jpg",
        title: "Tecnologia moderna e eficiente.",
        description:
          "Utilizamos as melhores práticas e ferramentas atuais para garantir performance e escalabilidade.",
      },
      {
        icon: "/our-way-03.jpg",
        title: "Parceria de longo prazo.",
        description:
          "Não apenas entregamos o projeto, mas acompanhamos sua evolução e crescimento contínuo.",
      },
    ],
  },
