import type { ServiceCardItem } from "./mainContent";

export const pnldContent = {
  hero: {
    title: "PNLD Digital, do InDesign ao edital, sem retrabalho.",
    subtitle:
      "Adaptação EPUB3 em 2–4 semanas com acessibilidade WCAG 2.1 AA, interatividade e conformidade total com o edital FNDE. Especialistas em editoras educacionais brasileiras.",
    image: "/hero-hand.svg",
    imageAlt:
      "Ilustração de mão pixelada representando adaptação digital de livros didáticos para o PNLD",
    buttons: [
      {
        text: "Pedir orçamento PNLD",
  ...
  services: {
    ...
    items: [
      ...
      { label: "OBJETOS DIGITAIS", canonical: "Objetos Digitais" },
      { label: "ACESSIBILIDADE", canonical: "Acessibilidade" },
      { label: "INTERATIVIDADE", canonical: "Interatividade" },
      { label: "AUDIODESCRIÇÃO", canonical: "Audiodescrição" },
      { label: "CONSULTORIA E SUPORTE", canonical: "Consultoria" },
  ...
  ctaBanner: {
    ...
    buttonText: "Iniciar projeto PNLD",
    whatsapp: {
    ...
    items: [
      {
        ...
        relatedLinks: [
          {
            label: "Leia o guia do PNLD 2028",
            href: "/blog/pnld-2028-2031-anos-finais-primeiras-informacoes",
      ...
      },
      {
        ...
        relatedLinks: [
          {
            label: "Pedir orçamento PNLD",
            href: "/pnld?service=PNLD%20Digital#contato",
        ...
        relatedLinks: [
          {
            ...
            href: "/pnld?service=Consultoria#contato",
            variant: "cta" as const,
          },
        ],
      },
      {
        ...
        relatedLinks: [
          {
            label: "Guia de EPUB acessível",
            href: "/blog/epub-acessivel-guia-completo",
            variant: "link" as const,
          },
        ],
      },
